...
Playwright smoke suite существует и запускается через команды выше. Для v0.21.1 результат уже зафиксирован: полные Rust gates прошли, Playwright smoke расширен до 12 тестов и прошёл; см. [`releases/v0.21.1.md`](releases/v0.21.1.md). Router deploy/E2E v0.21.0 зафиксирован отдельно в [`releases/v0.21.0.md`](releases/v0.21.0.md).
