...
fn fluent_dark_visuals() -> Visuals {
    ...
    visuals.widgets.inactive.bg_stroke = Stroke::new(1.0_f32, Color32::from_rgb(73, 73, 73));
    visuals.widgets.hovered.bg_stroke = Stroke::new(1.0_f32, Color32::from_rgb(96, 158, 210));
    visuals.widgets.active.bg_stroke = Stroke::new(1.0_f32, Color32::from_rgb(0, 120, 215));
    ...
    visuals.widgets.inactive.fg_stroke = Stroke::new(1.0_f32, Color32::from_rgb(242, 242, 242));
